// All editable site content lives here. Swap emojis for real product images later.

export const BRAND = {
  name: "MekBites",
  tagline: "Modern Day Snacking",
  phone: "+91 8793473970",
  phoneRaw: "918793473970",
...
export const WHY = [
  { icon: "🔥", bg: "#FF5A36", title: "Roasted, Not Fried", text: "Slow-roasted for crunch without the oil. Lighter on you, big on flavour." },
  { icon: "💪", bg: "#007B7F", title: "Rich in Protein", text: "A plant-powered protein boost to keep you full between meals." },
  { icon: "🌾", bg: "#5FBF4A", title: "High Dietary Fiber", text: "Supports digestion and keeps your gut happy, one handful at a time." },
  { icon: "🍃", bg: "#007B7F", title: "Low Calorie", text: "Snack freely. Every serving is light enough to enjoy any time of day." },
  { icon: "⭐", bg: "#FF5A36", title: "Premium Quality", text: "Hand-picked, top-grade makhana sourced for size, crunch and purity." },
  { icon: "🥣", bg: "#5FBF4A", title: "Everyday Healthy", text: "Made for real life — desk drawers, lunchboxes and late-night cravings." },
];
...
export const BENEFITS = [
  { title: "Supports a healthy lifestyle", text: "Wholesome, nutrient-dense snacking that fits any wellness routine." },
  { title: "Rich source of antioxidants", text: "Naturally packed with compounds that help your body fight daily stress." },
  { title: "Naturally gluten-free", text: "A safe, satisfying choice for gluten-sensitive snackers." },
  { title: "Light and crunchy", text: "Airy texture and a satisfying crunch without the heaviness." },
  { title: "Perfect tea-time snack", text: "The ideal companion for your chai, coffee or evening break." },
  { title: "Ideal for fitness folks", text: "Low-cal, high-protein fuel that works around your goals." },
];

export const TESTIMONIALS = [
  { text: "Finally a snack I don't feel guilty about. The Peri Peri is dangerously good — gone in two days flat.", name: "Aditi Sharma", role: "Pune", av: "A", avBg: "#FF5A36" },
  { text: "I keep a jar at my desk now. Crunchy, light and actually filling. The Tandoori flavour is unreal.", name: "Rohan Mehta", role: "Mumbai", av: "R", avBg: "#007B7F" },
  { text: "My kids love the Cream & Onion and I love that it's roasted not fried. A win for the whole family.", name: "Sneha Patil", role: "Nashik", av: "S", avBg: "#5FBF4A" },
];
